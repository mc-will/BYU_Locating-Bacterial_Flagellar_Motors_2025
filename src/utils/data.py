...
def select_tomo_ids(df, number_of_slices=[300], max_number_of_motors=1, y_shape_range=(924, 960), x_shape_range=(924, 960)) -> pd.Series:
    '''
    Return the list of the tomo_ids obtained by filtering the DataFrame base on the given parameters
            ...
            Parameters:
                    ...
                    max_number_of_motors (int): max number of motors
    ...
    df = df[(df['Array_shape_axis_0'].isin(number_of_slices)) & (df['Number_of_motors'] <= max_number_of_motors)]
